...
export class InMemoryDataService implements InMemoryDbService {
  createDb() {
    ...
    let ships = [
      { id: 1, name: 'Санта Мария', originalName: "Santa Maria", year: "1460", origin: 'Испания', description: "Санта Мария е най-големият от трите кораба използвани от Кристофор Колумб, с които прекосява Атлантическия океан през 1492 г.", photos:['ship1', 'ship2', 'ship3'] },
      { id: 2, name: 'Златната кошута', originalName: "Golden Hind(e)", year: "1577", origin: 'Англия', description: `През 1578 г. с прочутия си кораб „Златната кошута“ Сър Франсис Дрейк, придружен от моряци върху още 4 кораба, достига Южна Америка. Започва бунт срещу капитана, който е свирепо потушен. Вече на три кораба, Дрейк повежда екипажите все по на юг, за да заобиколи континента и да се озове от Атлантическия в Тихия океан.  Така на 24 октомври 1578 г. англичаните откриват протока Дрейк, разделящ Антарктида от Америка. Оттам поемат на Север по западното американска крайбрежие, като нападат, ограбват и убиват всеки испански кораб или крайбрежно селище (в днешните Чили и Перу) по пътя си.
      <br>
